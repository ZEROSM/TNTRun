                    ...
                    if (count($playersArena) === 0) {
                        ...
                        if (count($playersArena) >= $minPlayers) {
                            if ($timeToStart > 0) {
                                ...
                                foreach ($playersArena as $pl) {
                                    $pl->sendPopup("§l§7<< §f시작까지 §e" . $timeToStart . "§f초 남았습니다. §l§7>>");
                                    $this->plugin->getScheduler()->scheduleDelayedTask(new sendPopupAgain($this->plugin, "§l§7<< §f시작까지 §e" . $timeToStart . "§f초 남았습니다. §l§7>>", $pl), 10);
                                }
                                $config->setNested("arenas." . $name . ".time", $config->get("time"));
                                $config->save();
